...
path: it redeploys both, and there is no partial-deploy variant.
...
at both, 10 wide and 8 narrow), each a recipe of clicks against the card's own
...
- **`screenshot.mjs`: "Redirected to the login page …"**:
