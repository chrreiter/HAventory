...
- [ ] Frontend (`cards/haventory-card`): `npm audit --audit-level=moderate`, `npx eslint .`, `npm run typecheck`, `npx vitest run`, `npm run build` — the gate in full is in [CONTRIBUTING.md](../CONTRIBUTING.md#the-gate)
